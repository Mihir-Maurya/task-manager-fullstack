...
const Register = () => {
    ...
    const registerUser = async (e)=>{
        ...
        try {
           ...
           const response= await axios.post(`https://task-manager-api-psi.vercel.app/register`,{...user});
    ...
    const loginUser = async(e)=>{
        ...
        try {
            const response =await axios.post(`https://task-manager-api-psi.vercel.app/login`,userLogin)
